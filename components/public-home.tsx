...
export default function PublicHome() {
  return (
    <div>
      <section className="mx-auto max-w-[1100px] px-5 pb-14 pt-16 md:px-10 md:pb-20 md:pt-24">
        <div className="max-w-3xl animate-[fade-in_500ms_ease-out_both]">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link href="/accueil" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md bg-teal-900 px-6 font-medium text-primary-foreground transition-colors hover:bg-teal-700">Créer mon espace aidant <ArrowRight aria-hidden="true" data-icon="inline-end" /></Link>
      ...
      <section className="border-y border-sable-2 bg-sable/50"><div className="mx-auto max-w-[1100px] px-5 py-16 md:px-10 md:py-20"><div className="mx-auto max-w-2xl text-center"><p className="etiquette">Accès et abonnement</p><h2 className="mt-3 font-serif text-3xl text-teal-900 sm:text-4xl">Un dossier simple, sans grille compliquée.</h2><p className="mt-5 text-[17px] leading-7 text-encre-2">Un abonnement mensuel pour garder vos démarches, vos documents et vos questions au même endroit. Vous pouvez arrêter quand vous le souhaitez et récupérer vos données.</p><Link href="/accueil" className="mt-8 inline-flex min-h-12 items-center justify-center rounded-md bg-teal-900 px-6 font-medium text-primary-foreground hover:bg-teal-700">Créer mon espace aidant</Link></div></div></section>
      ...
      <section className="bg-teal-900 text-primary-foreground"><div className="mx-auto flex max-w-[1100px] flex-col gap-6 px-5 py-16 md:px-10 md:py-20"><h2 className="max-w-2xl font-serif text-3xl leading-tight sm:text-4xl">Vous accompagnez un proche. Horizon Proche tient le fil des démarches.</h2><Link href="/accueil" className="inline-flex min-h-12 w-fit items-center justify-center rounded-md bg-creme px-6 font-medium text-teal-900 hover:bg-sable">Créer mon espace aidant</Link></div></section>
    </div>
  )
}
